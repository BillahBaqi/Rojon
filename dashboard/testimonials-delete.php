...
$status_select = "SELECT * FROM testimonials WHERE id = $id";
...
if ($status_select_assoc['trash_status'] == 1) {
    $update = "UPDATE testimonials SET trash_status = 2 WHERE id=$id";
    $update_query = mysqli_query($db_connection, $update);
    header('location:testimonials.php');
}
else {
    $update = "UPDATE testimonials SET trash_status = 1 WHERE id=$id";
    $update_query = mysqli_query($db_connection, $update);
    header('location:testimonials.php');
}

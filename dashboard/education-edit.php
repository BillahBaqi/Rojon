...
$education_ids = $_GET['edit-id'];
$education_check_ids = "SELECT * FROM educations WHERE id='$education_ids'";
$education_check_query = mysqli_query($db_connection, $education_check_ids);
$education_check_assoc = mysqli_fetch_assoc($education_check_query);
        ...
        <div class="row row-sm mg-t-20">
            ...
            <div class="col-lg-4">
                <form action="education-update.php" method="POST">
                    <div class="card pd-20 pd-sm-30">
                        <h6 class="card-body-title">Edit Education</h6>
                        <div class="form-group">
                            <label class="form-control-label">Degree Name: <span class="tx-danger">* </span><span>(Bachelor, Diploma)</span></label>
                            <input class="form-control" type="text" name="degree" value="<?= $education_check_assoc['degree'] ?>" placeholder="Enter Degree Name">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="subject" value="<?= $education_check_assoc['subject'] ?>" placeholder="Enter Subject">
                            <span class="text-danger">
                                <?php
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" type="text" name="passing_year" value="" placeholder="Enter Subject">
                                <option value="<?= $education_check_assoc['passing_year'] ?>"><?= $education_check_assoc['passing_year'] ?></option>
                                <?php
                                $currentYear = date('Y');
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input class="form-control" type="text" name="percentage" value="<?= $education_check_assoc['percentage'] ?>" placeholder="Enter Percentage">
                        ...
                        <div class="form-layout-footer text-left">
                            <button type="submit" name="education" value="<?= $education_check_assoc['id'] ?>" class="btn btn-info mg-r-5 ">Submit</button>
                        </div>
                    </div><!-- card -->
                </form><!-- form -->
            </div><!-- col-6 -->

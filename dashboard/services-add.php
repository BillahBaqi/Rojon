                    ...
                    <div class="row mg-b-25">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="s_name" value="" placeholder="Enter Service Name">
                        ...
                        <div class="col-lg-12 ">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="editable" aria-label="With textarea" type="text" name="s_details" value="" placeholder="">Enter Service details...</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="file" name="s_icon" onchange="document.getElementById('service_icon_preview_id').src = window.URL.createObjectURL(this.files[0])">
